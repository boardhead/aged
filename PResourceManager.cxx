...
*/
 ...
 {"projType","ProjType",XtRInt,sizeof(int),XtOffset(AgedResPtr,projType),
 		XtRString, (XtPointer) "0" },
 {"projCoords","ProjCoords",XtRInt,sizeof(int),XtOffset(AgedResPtr,projCoords),
 		XtRString, (XtPointer) "0" },
 {"shapeOption","ShapeOption",XtRInt,sizeof(int),XtOffset(AgedResPtr,shapeOption),
 		XtRString, (XtPointer) "0" },
 {"record_index","RecordIndex",XtRInt,sizeof(int),XtOffset(AgedResPtr,record_index),
 		XtRString, (XtPointer) "0" },
 ...
 {"cursor_col",	"CursorCol",XtRPixel, sizeof(Pixel),XtOffset(AgedResPtr,colset[0][CURSOR_COL]),
 		XtRString, (XtPointer)"White"},
 {"fit_col",	"FitCol",  XtRPixel, sizeof(Pixel),XtOffset(AgedResPtr,colset[0][FIT_COL]),
 ...
 {"discarded_col","DiscardCol",XtRPixel, sizeof(Pixel),XtOffset(AgedResPtr,colset[0][DISCARDED_COL]),
 ...
 {"alt_cursor_col",	"AltCursorCol",XtRPixel, sizeof(Pixel),XtOffset(AgedResPtr,colset[1][CURSOR_COL]),
 		XtRString, (XtPointer)"Black"},
 {"alt_fit_col",	"AltFitCol",  XtRPixel, sizeof(Pixel),XtOffset(AgedResPtr,colset[1][FIT_COL]),
 		XtRString, (XtPointer)"Magenta"},
 ...
 {"alt_discarded_col","AltDiscardCol",XtRPixel, sizeof(Pixel),XtOffset(AgedResPtr,colset[1][DISCARDED_COL]),
 		XtRString, (XtPointer)"Grey80"},
